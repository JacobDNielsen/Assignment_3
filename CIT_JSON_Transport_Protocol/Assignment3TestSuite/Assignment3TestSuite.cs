    ...
    public static class Util
    {
        ...
        public static Response ReadResponse(this TcpClient client)
        {
            ...
            using (var memStream = new MemoryStream())
            {
                ...
                //return JsonSerializer.Deserialize<Response>(responseData); Denne er kommenteret ud, da vi bruger PropertyNamingPolicy is Server. Hvis vi havde brugt denne, vil den l�se Json data som pascal case. Vil vi ikke, da vi i ServerProgram l�ser det som CamelCase. P� denne m�de er det ens p� begge sider, og vi undg�r NullReferenceException
